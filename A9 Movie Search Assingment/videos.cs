    ...
    public class videos: media
    {
        ...
        public void display()
                {
                    ...
                    Console.WriteLine($"ID: {this.ID} Title: {this.title} Season: {this.format} Episode: {this.length} Region: {holder}");
                }
        ...
        public static void addVideo(List<videos> videosList){
            ...
            try{
                ...
                int newIds = (videosList[videosList.Count-1].ID+1);
        ...
        public static void addVideoJson(List<videos> videosList){
            String newTitle = "";
            try{
                Console.WriteLine("Enter Video Title: ");
                newTitle = Console.ReadLine();
                ...
                videosList.Add(tempVideos);
                String newEntry = $"{newIds},{newTitle},{newformat},{newLength},{regionFile}";
                var lines = File.ReadAllLines("videos.json");
                var videoJson = JsonNet.Serialize(tempVideos);
                lines[lines.Length-3] +=",";
                lines[lines.Length-2] = $"{videoJson}\n";
                File.WriteAllLines("videos.json", lines);
        }
    
        public static void jsonVideosOptions(List<videos> videosList){
            int choice=-1;
            while (choice!=3){
                try{
                    Console.WriteLine("Type 1 for Display options Type 2 to add a new entry Type 3 to exit: ");
                ...
                if(choice==1){
                    ...
                    videos.addVideoJson(videosList);
                }
            }
        }
    }
